  ...
  return (
    <Flex p={5} gap={7} flexDirection="column">
      <Flex flexDir={"column"} gap={7} p={7} bg={"white"} borderRadius={10}>
        ...
        <Text>
        هنا يشارك المجتمع والمهتمين من أطباء ومختصين وأسر مستفيدة خبراتهم وتجاربهم وتساؤلاتهم حول التوحد، من أساليب وطرق تساعد الأسر على التعامل مع التوحد بطرق فعالة ونهج سليم .
        </Text>
      </Flex>
      <Flex
